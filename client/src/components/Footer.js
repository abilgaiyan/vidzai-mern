          ...
          <div className="tt-footer-inner">
              <div className="row">
                  <div className="col-md-8 col-md-offset-2">
                      ...
                      <div className="tt-footer-text wow fadeInUp">Adios is NOT another boring WordPress theme – Possibilities Are Endless.<br />It’s almost impossible to create ugly website with Adios. </div>
